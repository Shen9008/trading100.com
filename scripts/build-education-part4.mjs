...
const GUIDES = [
  "what-is-usd-jpy-trading-guide",
  "forex-market-sessions-trading-hours-guide",
  "forex-vs-stocks-vs-crypto-guide",
  "what-is-xagusd-silver-trading-guide",
  "how-to-trade-nasdaq-100-index-guide",
];
...
const outPath = path.join(ROOT, "src/lib/data/education-guides-part4.ts");
